export const IndeedIcon = ({fill = 'currentColor', filled, size, height, width, label}) => {
    return (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="1.2em" height="1.2em"
                 stroke="currentColor" fill="currentColor"  viewBox="0 0 32 32">
