export const MailIcon = ({fill = 'currentColor', filled, size, height, width, label}) => {
    return (<svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1.1em" width="1.2em"  style={{ verticalAlign: 'sub'}}
